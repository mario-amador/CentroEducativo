...
urlpatterns = [
    ...
    path('impuestos/', ImpuestosListView.as_view(), name='impuesto_listar'),
    path('impuestos/crear/', ImpuestosCreateView.as_view(), name='impuesto_crear'),
    path('impuestos/ver/<int:pk>/', ImpuestosDetailView.as_view(), name='impuesto_detalle'),
    path('impuestos/editar/<int:pk>/', ImpuestosUpdateView.as_view(), name='impuesto_editar'),
    path('impuestos/eliminar/<int:pk>/', ImpuestosDeleteView.as_view(), name='impuesto_eliminar'),

    path('descuentos/', DescuentoListView.as_view(), name='descuento_listar'),
    path('descuentos/crear/', DescuentoCreateView.as_view(), name='descuento_crear'),
    path('descuentos/ver/<int:pk>/', DescuentoDetailView.as_view(), name='descuento_detalle'),
    path('descuentos/editar/<int:pk>/', DescuentoUpdateView.as_view(), name='descuento_editar'),
    path('descuentos/eliminar/<int:pk>/', DescuentoDeleteView.as_view(), name='descuento_eliminar'),

    path('impuestoshistoricos/', ImpuestoHistoricoListView.as_view(), name='impuestohistorico_listar'),
    path('impuestoshistoricos/crear/', ImpuestoHistoricoCreateView.as_view(), name='impuestohistorico_crear'),
    path('impuestoshistoricos/ver/<int:pk>/', ImpuestoHistoricoDetailView.as_view(), name='impuestohistorico_detalle'),
    path('impuestoshistoricos/editar/<int:pk>/', ImpuestoHistoricoUpdateView.as_view(), name='impuestohistorico_editar'),
    path('impuestoshistoricos/eliminar/<int:pk>/', ImpuestoHistoricoDeleteView.as_view(), name='impuestohistorico_eliminar'),
...
#expedientes
    ...
    #Parentesco
     path('parentesco/create/', ParentescoCreateView.as_view(), name='parentesco_create'),
     path('parentesco/list/', ParentescoListView.as_view(), name='parentesco_list'),
